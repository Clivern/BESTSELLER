...
class TestLogging(Base, TestCase):
    ...
    def test_get(self):
        ...
        self.assertTrue("Incoming GET Request to /_health with b''" in content and "INFO" in content)
        self.assertTrue("Outgoing 200 Response to /_health with b'{\"status\": \"ok\"}'" in content and "INFO" in content)
